...
arytmetyczne.prototype.a = function(i)
{
...
arytmetyczne.prototype.suma = function(i)
{
    if(this.a1 === null || this.r === null) return null;
    else if(i === 0) return this.a1;
    else
...
arytmetyczne.prototype.get_r = function()
{
    if(this.a1 === null || this.r === null) return null;
    else return this.r;
}

arytmetyczne.prototype[Symbol.iterator] = function*()
{
...
console.log('ciąg o właściwościach: ', x);
console.log('r:', x.r);
console.log('a1:', x.a1);
console.log('a4:', x.a(4));
console.log('suma4:', x.suma(4));

console.log('\nWypisanie kolejnych wyrazów ciągu przez generator:');
